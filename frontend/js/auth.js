...
class AuthManager {
    ...
    async handleLogout() {
        try {
            ...
            // Still redirect to login.html even if API call fails
            this.redirectToLogin();
        }
    }

    redirectToLogin() {
        // Get current path to determine the correct login page location
        const path = window.location.pathname;
        
        // Check if we're in a subdirectory (admin/, client/, or livreur/)
        if (path.includes('/admin/')) {
            window.location.href = '../index.html';
        } else if (path.includes('/livreur/')) {
            window.location.href = '../index.html';
        } else if (path.includes('/client/')) {
            window.location.href = '../index.html';
        } else {
            // We're at root (index.html, etc.)
            window.location.href = 'index.html';
        }
    }

    checkAuthStatus() {
        // Always verify token first - don't trust localStorage userData without token validation
        ...
        // No token - clear any legacy userData
